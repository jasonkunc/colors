...
const veganWords = {
    ...
    vegetables: [
        ...
        'basil', 'thyme', 'rosemary', 'sage', 'oregano', 'tarragon', 'marjoram', 'lavender', 'taro', 'Sunchoke'
    ],
    ...
    legumes: [
        'lentil', 'chickpea', 'bean', 'pea', 'soy', 'tofu', 'tempeh', 'edamame', 'fava bean', 'mung', 'adzuki', 'black bean',
    ...
    fungi: [
        ...
        'porcini', 'puffball', 'lions mane mushroom', 'Nameko', 'Bunashimeji', 'turkey tail mushroom', 
